...
#parser.add_argument('--model-path', default='./baseline/OurBaseline.pth') # save path
#parser.add_argument('--checkpoint-path', default='./baseline/OurBaseline.pth') # save path
parser.add_argument('--model-path', default='./save_folder2/model_xd.pth') # save path
parser.add_argument('--checkpoint-path', default='./save_folder2/checkpoint.pth') # save path
