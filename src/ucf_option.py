...
# vggish
parser.add_argument('--audio-list', default='./list/ucf_vgg_audio.csv')  # Added for MACIL-SD
parser.add_argument('--test-audio-list', default='./list/ucf_vgg_audiotest.csv')  # Added for MACIL-SD
