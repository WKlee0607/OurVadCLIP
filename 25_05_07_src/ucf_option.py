...
parser.add_argument('--model-path', default='./ucf_save/model_ucf.pth') # './ucf_save/OurBestModel/OurBestModel.pth'
parser.add_argument('--checkpoint-path', default='./ucf_save/checkpoint.pth') # './ucf_save/OurBestModel/OurBestModel.pth'
parser.add_argument('--visual-layers', default=3, type=int) # 수정본 -> 3
parser.add_argument('--attn-window', default=8, type=int) # 수정본 -> 8
parser.add_argument('--lr', default=2e-4) # 수정본 -> 2e-4
...
#parser.add_argument('--gt-path', default='./list/gt_ucf_R.npy') # Re-Annotation
