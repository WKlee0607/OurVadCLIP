...
# 이거 변경
parser.add_argument('--visual-layers', default=1, type=int) # ucf랑 다름
parser.add_argument('--attn-window', default=64, type=int) # ucf랑 다름
parser.add_argument('--classes-num', default=7, type=int) # ucf랑 다름
...
parser.add_argument('--model-path', default='./save_folder3/model_xd.pth') # save path
parser.add_argument('--checkpoint-path', default='./save_folder3/checkpoint.pth') # save path
