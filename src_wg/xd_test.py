...
def test(model, testdataloader, maxlen, prompt_text, gt, gtsegments, gtlabels, device):
    ...
    with torch.no_grad():
        for i, item in enumerate(testdataloader):
            ...
            #_, logits1, logits2, logits_visual, logits_audio, logits_av = model(visual, audio, padding_mask, prompt_text, lengths)
            _, _, logits2, logits1, logits_av = model(visual, audio, padding_mask, prompt_text, lengths)
